...
class VenuesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        FourSquareRequest().getVenuesWithLocation(CLLocation(), completion: { (venues) -> () in
...
[
    ...
    "location": [
        ...
        "lat": 33.752213530861276,
        "lng": -84.39295159827235,
        "distance": 82,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4bd5927729eb9c74dd7a93e1",
    "name": "Sam Nunn Atlanta Federal Center",
    "contact": {
    ...
    "location": {
        ...
        "crossStreet": "Forsyth",
        "lat": 33.75388877358989,
        "lng": -84.39326047897339,
        "distance": 142,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4bfab15c508c0f47d6504031",
    "name": "McDonald's",
    "contact": {
        "phone": "4045849483",
        "formattedPhone": "(404) 584-9483"
    },
    "location": {
        "address": "30 Marietta St NW",
        "crossStreet": "at Alabama St SW (MARTA: Five Points)",
        "lat": 33.75387985329286,
        "lng": -84.39260601997375,
        "distance": 119,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
        ...
        "country": "United States",
        "formattedAddress": [
        "30 Marietta St NW (at Alabama St SW (MARTA: Five Points))",
        "Atlanta, GA 30303",
        "United States"
        ]
    },
...
"menu": {
    ...
    "label": "Menu",
    "anchor": "View Menu",
    "url": "https:\/\/foursquare.com\/v\/mcdonalds\/4bfab15c508c0f47d6504031\/menu",
    "mobileUrl": "https:\/\/foursquare.com\/v\/4bfab15c508c0f47d6504031\/device_menu"
},
"specials": {
    "count": 0,
    "items": [
...
{
    "id": "514cb601e4b08860f235a0a2",
    "name": "Associated Credit Union",
    "contact": {
        
    },
    "location": {
        "address": "61 Forsyth St",
        "lat": 33.75327682495117,
        "lng": -84.3924331665039,
        "distance": 51,
        "cc": "US",
        "city": "Atlanta",
        "state": "GA",
...
{
    "id": "4efdf9d77ee5f14f38d6cb30",
    "name": "kiesha hair salon",
    "contact": {
        
    },
    "location": {
        "lat": 33.75299298507376,
        "lng": -84.39189966393637,
        "distance": 53,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "503bc1c2e4b01034f315462e",
    "name": "Associated & Federal Credit Union",
    "contact": {
...
{
    "id": "4f32b2a219836c91c7f0ea20",
    "name": "China Five",
    "contact": {
        "phone": "4045255722",
        "formattedPhone": "(404) 525-5722"
    },
    "location": {
        "address": "20 Broad St SW",
        "lat": 33.753254,
        "lng": -84.39212,
        "distance": 56,
        "postalCode": "30303",
...
{
    "id": "4d905afc1716a14385285ff7",
    "name": "Martin Luther King Jr Federal Building",
    "contact": {
        
    },
    "location": {
        "address": "77 Forsyth St SW",
        "lat": 33.75312731876387,
        "lng": -84.39391628250144,
        "distance": 141,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4d9f7085ed2437041e7cebba",
    "name": "Five Points Barbershop",
    "contact": {
        
    },
    "location": {
        "crossStreet": "Broad Street",
        "lat": 33.75258232644429,
        "lng": -84.39187913820135,
        "distance": 57,
        "cc": "US",
        "city": "Atlanta",
        "state": "GA",
...
{
    "id": "4e9766ee93ad93701b63ba3f",
    "name": "Yumm Teriyaki",
    "contact": {
        "phone": "4042232310",
        "formattedPhone": "(404) 223-2310",
        "twitter": "yummteriyaki"
    },
    "location": {
        "address": "87 Peachtree St SW",
        "lat": 33.7521778029023,
        "lng": -84.3921511036095,
        "distance": 75,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
"url": "http:\/\/atlantayummteriyaki-hub.com",
"delivery": {
    "url": "http:\/\/www.grubhub.com\/order_redir.jsp?custId=260071&affId=1131",
    "provider": {
        "name": "grubhub"
    }
},
...
{
    "id": "50f00c94e4b037d5ab3469bc",
    "name": "Broad Street Plaza",
    "contact": {
        
    },
    "location": {
        "address": "Broad Street",
        "lat": 33.75299448853342,
        "lng": -84.39176624653075,
        "distance": 64,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4c2630fd905a0f477ec56260",
    "name": "Legends Barber Shop",
    "contact": {
        "phone": "4045258100",
        "formattedPhone": "(404) 525-8100"
    },
    "location": {
        "address": "76 Upper Alabama St SW",
        "lat": 33.752724379860304,
        "lng": -84.39049780368805,
        "distance": 179,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4c06718a761ac9b610ee2074",
    "name": "Sports City",
    "contact": {
        "phone": "4046594126",
        "formattedPhone": "(404) 659-4126"
    },
    "location": {
        "address": "77 Peachtree St SW",
        "crossStreet": "Alabama St",
        "lat": 33.75251591205597,
        "lng": -84.3918389081955,
        "distance": 63,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4c0d02d9c700c9b605b5a1dd",
    "name": "Miller's Nature's Pharmacy",
    "contact": {
        
    },
    "location": {
        "address": "87 broad street",
        "crossStreet": "Martin Luther king jr. Blvd",
        "lat": 33.75237760164193,
        "lng": -84.39294646693097,
        "distance": 68,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
        ...
        "country": "United States",
        "formattedAddress": [
        "87 broad street (Martin Luther king jr. Blvd)",
        "Atlanta, GA 30303",
        "United States"
        ]
    },
...
{
    "id": "509d7ccbe4b005ecffb16472",
    "name": "break room",
    "contact": {
        
    },
    "location": {
        "lat": 33.75268552080362,
        "lng": -84.39175598364086,
        "distance": 63,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4a82bf8cf964a5204cf91fe3",
    "name": "Fulton County Government Center",
    "contact": {
        
    },
    "location": {
        "address": "141 Pryor St SW",
        "lat": 33.75122090092603,
        "lng": -84.39188940106975,
        "distance": 184,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
...
{
    "id": "4c635003e1621b8d99d12553",
    "name": "Kessler CityLofts Fitness Center",
    "contact": {
...
{
    "id": "4e1cbf8214954cd5e425f778",
    "name": "Secret Essence",
    "contact": {
        "phone": "4045894919",
        "formattedPhone": "(404) 589-4919"
    },
    "location": {
        "address": "105 Peachtree St SW",
        "crossStreet": "MLK",
        "lat": 33.75222544350494,
        "lng": -84.39203308103956,
        "distance": 74,
        "postalCode": "30303",
        "cc": "US",
        "city": "Atlanta",
